    ...
    fun fn ->
      ...
      let rec hash_deps out uu___ =
        ...
        | fn2::deps1 ->
            ...
            let digest =
              let uu___1 = FStar_Compiler_Util.smap_try_find mcache cache_fn in
              match uu___1 with
              | FStar_Pervasives_Native.None ->
                  let msg =
      ...
      (let elt =
       ...
       then FStar_Compiler_Effect.op_Bar_Greater elt FStar_Compiler_Util.must
         ...
         (let add_and_return elt1 =
          ...
          if Prims.op_Negation (FStar_Compiler_Util.file_exists checked_fn)
          then
            let msg =
                   ...
                   | (deps_dig, tc_result1) ->
                       ...
                       then
                         let elt1 =
                           let uu___3 =
                             let uu___4 =
                               FStar_Compiler_Util.digest_of_file checked_fn in
                             Valid uu___4 in
                         ...
                         ((let uu___5 =
                           ...
                           then
                             ((let uu___7 =
                                 FStar_Compiler_Util.string_of_int
                                   (FStar_Compiler_List.length deps_dig') in
                               let uu___8 =
                          ...
                          (let msg =
                           ...
                           FStar_Compiler_Util.smap_add mcache checked_fn
                             elt1;
                           FStar_Pervasives.Inl msg)))))
        ...
        fun tc_result1 ->
          ...
          then
            ...
            | FStar_Pervasives.Inr hashes ->
                ...
                let stage1 =
                  let uu___1 = FStar_Compiler_Util.digest_of_file fn in
                  {
